...
async def _ai_match_new_service(pid: int, name: str, description: str = "", business_id: int | None = None):
    ...
    synonym_groups = [
        ...
        {"յուղ", "յուղի փոխարինում", "յուղի և ֆիլտրերի փոխարինում", "масло", "замена масла", "замена масла и фильтров", "oil change", "oil and filter change"},
        {"արգելակ", "արգելակային կալոդկա", "արգելակային կալոդկաների փոխարինում", "тормоз", "тормозные колодки", "замена тормозных колодок", "brake", "brake pads", "brake pad replacement"},
        {"ախտորոշում", "համակարգչային դիագնոստիկա", "автодиагностика", "диагностика автомобиля", "компьютерная диагностика", "car diagnostics", "computer diagnostics"},
        {"անիվ", "անվադող", "անիվների փոխում", "անվադողերի փոխարինում", "шиномонтаж", "замена колес", "замена шин", "колеса", "tires", "tire change"},
    ]
